    ...
    <article class="mx-auto max-w-3xl px-6 pb-24 pt-6 lg:pt-10">
        ...
        <section class="mt-16 border-t border-white/8 pt-8">
            ...
            <div class="prose mt-4 max-w-2xl text-sm leading-relaxed text-muted/70">
                <p>{{ $total }} samples across four layers (continuous ambient beds, enriching textures, foreground melodies, and short accents), roughly 240 MB, bundled entirely in the app: nothing streamed, fully offline.</p>
                ...
                <p>Most are sourced from lossless masters (WAV, FLAC, or AIFF, up to 24-bit / 96 kHz); a small number were only ever published lossy and are the best available. The set compresses from about 5 GB of originals down to roughly 240 MB, with no audible loss on this material.</p>
