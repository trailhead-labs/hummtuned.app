    ...
    <article class="mx-auto max-w-3xl px-6 pb-24 pt-6 lg:pt-10">
        ...
        <section class="mt-16 border-t border-white/8 pt-8">
            ...
            <div class="prose mt-4 max-w-2xl text-sm leading-relaxed text-muted/70">
                <p>{{ $total }} samples across three layers (continuous ambient beds, medium textures, and short accents), roughly 110 MB, bundled entirely in the app: nothing streamed, fully offline.</p>
                <p>Shipped as Opus in an Ogg container at 48 kHz, with bitrate tiered by material: ambient beds at 80 kbps, tonal textures and accents at 96 kbps. Channels are preserved per source (mostly stereo, some mono point-sources). Decoded natively by the OS on iOS 17+ and Android 5.0+.</p>
                <p>Most are sourced from lossless masters (WAV, FLAC, or AIFF, up to 24-bit / 96 kHz); a small number were only ever published lossy and are the best available. The set compresses from about 2.5 GB of originals down to roughly 110 MB, with no audible loss on this material.</p>
                <p>Every sample is silence-trimmed and loudness-normalized: continuous layers to -16 LUFS (EBU R128), short accents true-peak normalized, everything true-peak limited to between -1 and -1.5 dBTP. So nothing clips and the generative mix always sits at a consistent level.</p>
