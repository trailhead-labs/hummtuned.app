            ...
            <div class="mt-12">
                ...
                <div class="why-panel" data-why-panel="fresh" role="tabpanel">
                    <div class="grid items-start gap-12 md:grid-cols-2">
                        ...
                        <div class="mx-auto w-full min-w-0 max-w-sm md:mx-0 md:max-w-none"><x-scene-player /></div>
                    </div>
                </div>
                ...
                <div class="why-panel" data-why-panel="research" role="tabpanel" hidden>
                    <div class="grid items-start gap-12 md:grid-cols-2">
                        ...
                        <div class="mx-auto w-full min-w-0 max-w-sm md:mx-0 md:max-w-none"><x-why-stage tone="research" /></div>
                    </div>
                </div>
                ...
                <div class="why-panel" data-why-panel="config" role="tabpanel" hidden>
                    <div class="grid items-start gap-12 md:grid-cols-2">
                        ...
                        <div class="mx-auto w-full min-w-0 max-w-sm md:mx-0 md:max-w-none"><x-why-stage tone="config" /></div>
                    </div>
                </div>
