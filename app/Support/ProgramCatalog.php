...
class ProgramCatalog
{
    ...
    public static function groups(): array
    {
        return [
            ...
            'Experiential' => [
                'experiential' => true,
                'science_intro' => 'Traditional practices, offered for exploration. There is no controlled science behind these effects. They are grounded in what each tradition actually uses and in decades of subjective report, and the app says so in plain words. We do not oversell them.',
            ],
        ];
    }
    ...
    public static function programs(): array
    {
        return [
            ...
            'Lucid Dreaming' => [
                ...
                'grade' => 'Weak, traditional',
                'tier' => 'experiential',
                'grounding' => 'We will be blunt: no controlled trial shows binaural beats induce lucid dreams, at any frequency. Theta is the traditional and indirect anchor because it is REM\'s dominant rhythm, so Humm holds a light 5 Hz theta and plays through the night, when dreams run longest, with no end chime to wake you. The one causal hint in the literature came from frontal 40 Hz gamma electrical stimulation (Voss 2014), but that is electrical, not audio, and it failed replication (2020). This one is offered for exploration, not as a proven effect.',
            ],
            'Power Nap' => [
            ...
            'Astral Projection' => [
                ...
                'grade' => 'Weak, traditional',
                'tier' => 'experiential',
                'grounding' => 'The modern astral community converges tightly on roughly 6 Hz as its canonical number, and Humm matches it. On the 200 Hz Monroe carrier, played from deep relaxation while you stay awake.',
            ],
            'Out-of-Body Experience' => [
                ...
                'grade' => 'Weak to none',
                'tier' => 'experiential',
                'grounding' => 'The Monroe and Campbell tradition puts the out-of-body trigger lower than the astral value, around 4 Hz; their first such recording was reportedly near 3.78 Hz. Humm sits at 4 Hz, below the 6 Hz astral program, which both matches the tradition and cleanly separates the two. Even insiders are skeptical that beats reliably trigger the experience, and we pass that skepticism along.',
            ],
            'Deep Trance' => [
